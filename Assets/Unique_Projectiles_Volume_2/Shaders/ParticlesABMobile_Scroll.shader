...
Shader "GAP/ParticlesABMobile_Scroll"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				return GAPSampleMobileScroll(i, _Color, _MainTexTiling, _MainTexSpeed, _DistortionAmount,
					_DistortionTiling1, _DistortionSpeed, _DissolveAmount, _DissolveTiling1, _DissolveSpeed,
