...
Shader "GAP/AlphaBlendedDistortionScroll" {
    ...
    SubShader {
        ...
        Pass {
            ...
            {
                return GAPDistortionScrollAlpha(i, _TintColor, _ColorMultiplier, _MainTextUSpeed, _MainTextVSpeed,
                    ...
                    _MainTex_ST, _Gradient_ST, _Distortion_ST, _MainTexMask_ST,
                    TEXTURE2D_ARGS(_MainTex, sampler_MainTex), TEXTURE2D_ARGS(_Gradient, sampler_Gradient),
                    TEXTURE2D_ARGS(_Distortion, sampler_Distortion), TEXTURE2D_ARGS(_MainTexMask, sampler_MainTexMask));
            }
            ENDHLSL
        }
    }
